        ...
        <nav className="bg-gray-900 text-white border-b border-gray-700 shadow-md">
            <div className="flex justify-between items-center p-4">
                ...
                <div className="hidden lg:flex gap-4">
                    ...
                    <Link to="/contests"><button className="px-3 py-2 rounded hover:bg-gray-800">Contests</button></Link>
                ...
                <div className="hidden lg:flex items-center gap-3">
                    {isAuthenticated && profile ? (
                        <>
                            <Link to="/profile"><button className="px-3 py-2 bg-blue-700 rounded hover:bg-blue-800">Profile</button></Link>
